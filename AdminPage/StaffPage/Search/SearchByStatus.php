...
FROM traineeinfo
    ...
    JOIN contactinfo
        ON contactinfo.ID = trainingapplication.ID WHERE trainingapplication.TrainingStatus LIKE %s ", GetSQLValueString("%" . $colname_searching. "%", "text"));
...
?>
    ...
    <div align="center"><a href="../StaffHomePage.php">
