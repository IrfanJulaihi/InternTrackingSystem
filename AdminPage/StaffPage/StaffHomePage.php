...
$MM_restrictGoTo = "../AdminHomePage.php";
...
<ul id="MenuBar1" class="MenuBarHorizontal">
  ...
  <li><a href="#" class="MenuBarItemSubmenu">Print</a>
    <ul>
...
<div align="center">  <a href="#" class="MenuBarItemSubmenu">
  <select name="SearchForm2" onchange="changeAction(this.value)">
...
<span style="position: absolute; right: 700px; top: 294px;">
...
<table width="263%" border="1" class="CSSTableGenerator">
    ...
    <?php do { ?>
      <tr>
        <td><div align="center">
        <a href="../../StaffPage/TraineeDetailInfo.php?ID=<?php echo $row_Recordset1['ID'];?>">PT</a><a href="TraineeDetailInfo.php?ID=<?php echo $row_Recordset1['ID'];?>"><?php echo $row_Recordset1['ID']; ?></a><a href="TraineeDetailInfo.php?ID=<?php echo $row_Recordset1['ID'];?>">/<?php echo date("y",strtotime($row_Recordset1['StartDate']));?></a></div></td>
