...
function CopyAddress(f) {
     ...
     document.getElementById("MailingAddress").value = document.getElementById("HomeAddress").value+delimeter+document.getElementById("City").value+delimeter+document.getElementById("State").value;
		 }
    }
</script>
</head>
...
text-shadow: rgb(230, 172, 172) -2px 5px 5px;">
      ...
      <tr>
        ...
        <td><span id="sprytextarea1">
          ...
          <textarea name="HomeAddress" id="HomeAddress" cols="45" rows="5"><?php echo $row_trainee['HomeAddress']; ?></textarea>
